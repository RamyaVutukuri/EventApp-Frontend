...
export class WishlistComponent {
  ...
  ngOnInit():void{
    this.viewWishlistedEvents();
  }

  viewWishlistedEvents(){
    this.eventService.getAllWishlistedEvents().subscribe(
    (data:any)=>{
      this.events=data;
  ...
  deleteWishlistedEvent(id:number){
    this.eventService.deleteWishlistedEvent(id).subscribe(
      (data)=>{
        console.log(data);
